...
-- Command     : write_vhdl -force -mode synth_stub -rename_top monitor_seu_fifo -prefix
--               monitor_seu_fifo_ monitor_seu_fifo_stub.vhdl
...
architecture stub of monitor_seu_fifo is
